...
Route::get('/paginaprincipal', [DirectorioController::class , 'paginaPrincipal'])->name('principal.mostrar');
...
Route::get('/directorio/eliminar/destroy', [DirectorioController::class , 'destroy'])->name('directorio.destroy');
